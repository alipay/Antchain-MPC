...
#         self.addLayer(layer)
#         # convolutional layer with 1 input channel, 5 output channels and a 5×5 filter, stride=2
#         layer = Conv2d(output_dim=None, fathers=[layer], filters=5, strides=[1,2,2,1],
#                        kernel_size=5, input_shape=[28, 28, 1])
#         self.addLayer(layer)
#         print("output_dim of Conv2D=", layer.output_dim)
#         # Relu Layer
...
class NetworkD(NN):
    ...
    def __init__(self, feature, label):
        ...
        # convolutional layer with 1 input channel, 5 output channels and a 5×5 filter, stride=2
        layer = Conv2d(output_dim=None, fathers=[layer], filters=5, strides=[1,2,2,1],
                       kernel_size=5, input_shape=[28, 28, 1], activate='relu')
        self.addLayer(layer)
        print("output_dim of Conv2D=", layer.output_dim)
