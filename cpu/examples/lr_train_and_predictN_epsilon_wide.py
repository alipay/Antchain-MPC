...
# ----------- build a LR model ---------------
model = LogisticRegressionWide(num_features=featureNums, learning_rate=learning_rate)
...
model.fit(sess=sess, x=x_trains, y=y_train, num_batches=train_batch_num)
...
# --------------predict --------------
model.predict(id, x_tests, pred_batch_num, sess)
sess.close()
