...
class Precompute
{
    ...
    public:
        ...
        template<typename T, typename Share>
        void getSinTriples(Share &x, Share &y, size_t m, size_t rows, size_t cols) {
            // sin (2kpi x/2^m)=y
            x.fill(0);
            y.fill(0);
        }
        ...
        template<typename T, typename Share>
        void getCosTriples(Share &x, Share &y, size_t m, size_t rows, size_t cols) {
            // cos (2kpi x/2^m)=y
            x.fill(0);
            y.fill((T) (1<<FLOAT_PRECISION));
        }
